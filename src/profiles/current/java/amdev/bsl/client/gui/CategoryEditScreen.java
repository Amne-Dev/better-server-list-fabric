...
public final class CategoryEditScreen extends Screen {
	...
	protected void init() {
		...
		this.addRenderableWidget(
			Button.builder(Component.translatable("gui.cancel"), button -> this.minecraft.gui.setScreen(this.parent)).bounds(centerX + 55, centerY + 22, 100, 20).build()
		);
	}
	...
	public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
		...
		guiGraphics.centeredText(this.font, Component.translatable("bsl.screen.category_edit.hint"), this.width / 2, this.height / 2 - 22, 0xFFA0A0A0);
