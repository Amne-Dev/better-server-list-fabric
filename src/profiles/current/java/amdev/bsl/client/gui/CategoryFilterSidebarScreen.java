...
public final class CategoryFilterSidebarScreen extends Screen {
	...
	public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
		...
		this.parent.extractRenderState(guiGraphics, mouseX, mouseY, partialTick);
	...
	private void bsl$openPage(int targetPage) {
		this.minecraft.gui.setScreen(new CategoryFilterSidebarScreen(this.parent, this.activeCategory, this.onSelect, targetPage));
	}
