...
public final class ServerBrowserScreen extends Screen {
	...
	protected void init() {
		...
		this.searchField = this.addRenderableWidget(new EditBox(this.font, this.buttonX, 16, this.buttonWidth, 20, new TranslatableComponent("bsl.browser.search_field")));
	...
	public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
		...
		Component resultsComp = new TranslatableComponent("bsl.browser.results", this.filteredEntries.size());
