...
public final class ServerBrowserScreen extends Screen {
	...
	protected void init() {
		...
		this.searchField = this.addButton(new EditBox(this.font, this.buttonX, 18, this.buttonWidth, 20, new TextComponent("Search public servers")));
		...
		this.previousPageButton = this.addButton(new Button(prevX, controlsY, 75, 20, new TextComponent("< Prev"), b -> this.bsl$changePage(-1)));
		this.nextPageButton = this.addButton(new Button(nextX, controlsY, 75, 20, new TextComponent("Next >"), b -> this.bsl$changePage(1)));
		this.addButton = this.addButton(new Button(addX, controlsY, 110, 20, new TextComponent("Add Selected"), b -> this.bsl$addSelectedServer()));
		this.openWebsiteButton = this.addButton(new Button(websiteX, controlsY, 110, 20, new TextComponent("Open Website"), b -> this.bsl$openSelectedWebsite()));
		this.refreshApiButton = this.addButton(new Button(reloadX, controlsY, 100, 20, new TextComponent("Reload API"), b -> this.bsl$loadLiveCatalog(true)));
		this.addButton(new Button(doneX, controlsY, 75, 20, new TextComponent("Done"), b -> this.minecraft.setScreen(this.parent)));
