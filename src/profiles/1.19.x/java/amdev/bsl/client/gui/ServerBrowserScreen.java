...
public final class ServerBrowserScreen extends Screen {
	...
	protected void init() {
		...
		this.searchField = this.addRenderableWidget(new EditBox(this.font, this.buttonX, 18, this.buttonWidth, 20, Component.literal("Search public servers")));
		...
		this.previousPageButton = this.addRenderableWidget(this.bsl$makeButton(prevX, controlsY, 75, 20, Component.literal("< Prev"), b -> this.bsl$changePage(-1)));
		this.nextPageButton = this.addRenderableWidget(this.bsl$makeButton(nextX, controlsY, 75, 20, Component.literal("Next >"), b -> this.bsl$changePage(1)));
		this.addButton = this.addRenderableWidget(this.bsl$makeButton(addX, controlsY, 110, 20, Component.literal("Add Selected"), b -> this.bsl$addSelectedServer()));
		this.openWebsiteButton = this.addRenderableWidget(this.bsl$makeButton(websiteX, controlsY, 110, 20, Component.literal("Open Website"), b -> this.bsl$openSelectedWebsite()));
		this.refreshApiButton = this.addRenderableWidget(this.bsl$makeButton(reloadX, controlsY, 100, 20, Component.literal("Reload API"), b -> this.bsl$loadLiveCatalog(true)));
		this.addRenderableWidget(this.bsl$makeButton(doneX, controlsY, 75, 20, Component.literal("Done"), b -> this.minecraft.setScreen(this.parent)));
