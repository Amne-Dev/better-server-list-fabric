...
public final class ServerBrowserScreen extends Screen {
	...
	protected void init() {
		...
		this.searchField = this.addRenderableWidget(new EditBox(this.font, this.buttonX, 18, this.buttonWidth, 20, Component.translatable("bsl.browser.search_field")));
	...
	public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
		...
		drawString(poseStack, this.font, Component.translatable("bsl.browser.results", this.filteredEntries.size()), 10, this.height - 76, 0xFFA0A0A0);
